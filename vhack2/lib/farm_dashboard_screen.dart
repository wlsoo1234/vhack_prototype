              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      _buildFloatingIcon(
                        iconUrl: 'https://placehold.co/24x24?text=Calendar',
                      ...
                      _buildFloatingIcon(
                        iconUrl: 'https://placehold.co/24x24?text=Robot',
                  ...
                  children: [
                    ...
                    IconButton(
                      icon: Image.network(
                        ...
                        height: 24,
                        errorBuilder: (context, error, stackTrace) {
                          return const Icon(Icons.smart_toy, color: Colors.black);
                        },
                      ),
                      onPressed: () {
                        Navigator.push(
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => CropEntryScreen(
                              onCropAdded: (cropName) {
                                setState(() {
                                  _crops.add({
                                    'name': cropName,
    ...
    return Container(
      ...
      child: IconButton(
        icon: Image.network(
          ...
          height: 24,
          errorBuilder: (context, error, stackTrace) {
            return Icon(fallbackIcon, size: 20);
          },
        ),
        onPressed: onPressed,
        padding: EdgeInsets.zero,
